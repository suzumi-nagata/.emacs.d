...
(setq projects-roots-path (append projects-roots-path (alist-project-files "/files/backup/Projects/Programming")))
(setq projects-roots-path (append projects-roots-path (alist-project-files "/files/backup/Projects/Programming/go")))
(setq projects-roots-path (append projects-roots-path (alist-project-files "/files/backup/Projects/Programming/c")))
(setq projects-roots-path (append projects-roots-path (alist-project-files "/files/backup/Projects/Programming/java")))
(setq projects-roots-path (append projects-roots-path (alist-project-files "/files/repos")))
